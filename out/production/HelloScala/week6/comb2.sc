...
case object Skip extends Stmt // equals NOP
...
// Tparser(T_key("skip")).map[Stmt]{_ => Skip }
...
println(Stmts.parse_all("x:=5;y:=8;z:=10"))
println(Block.parse_all("if(a<b)thenskipelsea:=a*b+1"))
